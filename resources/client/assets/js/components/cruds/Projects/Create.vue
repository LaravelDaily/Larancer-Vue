...
export default {
    ...
    created() {
        ...
        this.fetchProjectstatusesAll()
    },
    destroyed() {
        this.resetState()
    },
    methods: {
        ...mapActions('ProjectsSingle', ['storeData', 'resetState', 'setTitle', 'setClient', 'setDescription', 'setStart_date', 'setBudget', 'setProject_status', 'fetchClientsAll', 'fetchProjectstatusesAll']),
        updateTitle(e) {
