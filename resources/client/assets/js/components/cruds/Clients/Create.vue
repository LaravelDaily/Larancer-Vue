...
export default {
    ...
    created() {
        this.fetchClientstatusesAll()
    },
    destroyed() {
        this.resetState()
    },
    methods: {
        ...mapActions('ClientsSingle', ['storeData', 'resetState', 'setFirst_name', 'setLast_name', 'setCompany_name', 'setEmail', 'setPhone', 'setWebsite', 'setSkype', 'setCountry', 'setClient_status', 'fetchClientstatusesAll']),
        updateFirst_name(e) {
