...
export default {
    ...
    methods: {
        ...mapActions('TransactionsSingle', ['fetchData', 'updateData', 'resetState', 'setProject', 'setTransaction_type', 'setIncome_source', 'setTitle', 'setDescription', 'setAmount', 'setCurrency', 'setTransaction_date']),
        updateProject(value) {
